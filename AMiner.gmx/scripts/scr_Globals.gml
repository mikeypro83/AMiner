...
globalvar global.level_odoorexit = noone;
globalvar global.level_odoorhome = noone;

//globalvar global.level_oplayer = noone;		// this helps up access the player object instance in the game whenever we want it.
